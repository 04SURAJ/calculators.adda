...
function GravelCalculator() {
  const seo = calculatorsSeo["gravel-calculator"];
  ...
  const calculateGravel = () => {
    ...
    if (unit === "metric") {
      ...
      setResult(`${volume.toFixed(2)} m³ of gravel`);
    } else {
      // imperial: ft × ft × in → cubic feet
      volume = l * w * (d / 12); // cubic feet
      setResult(`${volume.toFixed(2)} ft³ of gravel`);
    }
  };
  ...
  <div className="row g-2 mb-3">
      ...
      {result && (
        <div className="alert alert-success">
          <strong>Gravel Required:</strong> {result}
        </div>
      )}     
    </CalculatorLayout>  
